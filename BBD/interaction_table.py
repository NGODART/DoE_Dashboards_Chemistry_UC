...
# Import data
#df = pd.read_excel('C:/Users/GodarN30918/OneDrive - PerkinElmer Inc/Desktop/DOE Project/Designs/First Use Case - Optimization of Copper-Mediated 18F-Fluorination Reactions/RSO_BB_Design_skeleton_w_results.xlsx')
df = SFData
...
for factor_pair in factor_combinations:
    ...
    for level_pair in level_combinations:
        ...
        mean_rcc_value = filtered_df[Res_column].mean()
